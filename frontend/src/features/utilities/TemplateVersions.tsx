...
export function TemplateVersions({ id, revision, refresh }: { id: string; revision: number; refresh: () => Promise<void> }) {
  ...
  const mutation = useMutation({ mutationFn: async () => {
    ...
    return apiRequest(`/templates/${id}/replace`, { method: "POST", headers: { Authorization: `Bearer ${readAccessToken()}` }, body: form });
